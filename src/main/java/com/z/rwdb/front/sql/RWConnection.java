...
public class RWConnection implements Connection {
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		return new RWPreparedStatement( this,sql);

	}

	@Override
	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
		return new RWPreparedStatement(this,sql, autoGeneratedKeys);
	}
	
	@Override
	public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
		return new RWPreparedStatement( this,sql, columnIndexes);
	}
	
	@Override
	public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
		return new RWPreparedStatement( this,sql, columnNames);
	}
	
	@Override
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
			throws SQLException {
		return new RWPreparedStatement( this,sql, resultSetType, resultSetConcurrency);
	}
	
	@Override
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
			int resultSetHoldability) throws SQLException {
		return new RWPreparedStatement(this,sql,  resultSetType, resultSetConcurrency, resultSetHoldability);
	}
	...
	public void commit() throws SQLException {
		if (realConn != null) {
			realConn.commit();
			log.debug("connid={},Thread id={},invoke rwConnection$commit method,realConn={}",this.connId, Thread.currentThread().getId(),
					realConn);
		}
		if (REALWDB_CONNECTION.get() != null) {
			REALWDB_CONNECTION.get().commit();
			log.debug("connid={},Thread id={},invoke rwConnection$commit method,localConn={}", this.connId,Thread.currentThread().getId(),
					REALWDB_CONNECTION.get());
		}

		log.debug("connid={},Thread id={},invoke rwConnection$commit method", this.connId,Thread.currentThread().getId());
	}
	...
	public void rollback() throws SQLException {
		...
		if (REALWDB_CONNECTION.get() != null)
			REALWDB_CONNECTION.get().rollback();
	}
	...
	public void close() throws SQLException {
		...
		if (REALWDB_CONNECTION.get() != null) {
			REALWDB_CONNECTION.get().close();
			REALWDB_CONNECTION.remove();
		}
		 ...
		 */
		log.debug("connId={},Thread id={},invoke rwConnection$close method",this.connId, Thread.currentThread().getId());
	}
	...
	public static ThreadLocal<Connection> REALWDB_CONNECTION = new ThreadLocal<Connection>(); //这里保存的是写库的connection
	...
	public String nativeSQL(String sql) throws SQLException {
		...
		throw SQLError.createSQLException("nativeSQL can't execute");
	}
	...
	public void releaseSavepoint(Savepoint savepoint) throws SQLException {
		 ...
		 */
		if (REALWDB_CONNECTION.get() != null)
			REALWDB_CONNECTION.get().releaseSavepoint(savepoint);
	}
	...
	public void rollback(Savepoint savepoint) throws SQLException {
		 ...
		 */
		if (REALWDB_CONNECTION.get() != null)
			REALWDB_CONNECTION.get().rollback(savepoint);
	}
	...
	public Savepoint setSavepoint() throws SQLException {
		 ...
		 */
		if (REALWDB_CONNECTION.get() != null)
			REALWDB_CONNECTION.get().setSavepoint();
	...
	public Savepoint setSavepoint(String name) throws SQLException {
		 ...
		 */
		if (REALWDB_CONNECTION.get() != null)
			REALWDB_CONNECTION.get().setSavepoint(name);
		throw SQLError.createSQLException("setSavepoint can't execute");
	}
