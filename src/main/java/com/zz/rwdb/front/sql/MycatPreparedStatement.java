...
public class MycatPreparedStatement extends MycatStatement implements PreparedStatement {
    ...
    public MycatPreparedStatement(String sql, MycatConnection conn, int autoGeneratedKeys) {
        this(sql, conn);
        super.autoGeneratedKeys = autoGeneratedKeys;
        super.createMethodByCon = MycatPreparedStatement.CREATE_PS_METHOD_BY_CON_S_I;
    }

    public MycatPreparedStatement(String sql, MycatConnection conn, int[] columnIndexes) {
        this(sql, conn);
        super.columnIndexes = columnIndexes;
        super.createMethodByCon = MycatPreparedStatement.CREATE_PS_METHOD_BY_CON_S_$I;
    }

    public MycatPreparedStatement(String sql, MycatConnection conn, String[] columnNames) {
        this(sql, conn);
        super.columnNames = columnNames;
        super.createMethodByCon = MycatPreparedStatement.CREATE_PS_METHOD_BY_CON_S_$S;
    }

    public MycatPreparedStatement(String sql, MycatConnection conn, int resultSetType, int resultSetConcurrency) {
        this(sql, conn);
